...
from differentiable_depthmap import render_depthmap
...
if __name__ == "__main__":
    ...
    # znears = torch.ones([1,num_views], device=device) * 1.5
    # zfars = torch.ones([1,num_views], device=device) * 3.0
    ...
    # images = depthmap_renderer(meshes, cameras=cameras, znear=znears, zfar=zfars)

    images = render_depthmap(polydata=trg_polydata)

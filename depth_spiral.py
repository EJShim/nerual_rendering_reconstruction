...
from differentiable_depthmap import NeuralDepthRenderer
...
if __name__ == "__main__":
    ...
    neural_renderer = NeuralDepthRenderer()
    neural_renderer.set_polydata(trg_polydata)
    neural_renderer.azim = 180
    ...
    depth_images = neural_renderer.render()


    # sample_im = torch.cat((silhouette_images, depth_images), dim=1)
    sample_image = depth_images[0].detach().cpu().numpy()
